...
//     BaseView may be freely distributed under the MIT license.
...
(function (root, factory) {
...
}(window || global, function (root, exports, Backbone, _, $) {
    "use strict";
    var
        ...
        BaseView,
        /**
         * Local constructor intended for use by {@link BaseView}. Creates an object specifically
         ...
         * @param {BaseView} parent The parent BaseView instance
         * @param [options]
         */
    ...
    SubViewManager.prototype = {
       /**
         ...
         *      {
         *          construct:  // Constructor function or string version (i.e. "BaseView")
        ...
        renderAppend: function (appendTo, options) {
            options = options || {};
            if (isObject(appendTo) && appendTo instanceof $ === false && !_.isElement(appendTo)) {
                options = appendTo;
    ...
    BaseView = View.extend({
        ...
        // If this is a subView of another BaseView, this will be a ref to that view instance
        parentView: null,
         ...
         *         A BaseView constructor function
         * @return {BaseView|null}
         */
